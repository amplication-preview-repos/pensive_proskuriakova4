...
@InputType()
class PriceHistoryCreateNestedManyWithoutCropsInput {
...
export { PriceHistoryCreateNestedManyWithoutCropsInput as PriceHistoryCreateNestedManyWithoutCropsInput };
